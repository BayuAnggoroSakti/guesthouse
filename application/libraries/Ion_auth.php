...
class Ion_auth
{
	...
	public function is_owner($id = FALSE)
	{
		...
		return $this->ion_auth_model->in_group($owner_group, $id);
	}

	public function is_kontraktor($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_kontraktor');

		$kontraktor_group = 5;

		return $this->ion_auth_model->in_group($kontraktor_group, $id);
	}
