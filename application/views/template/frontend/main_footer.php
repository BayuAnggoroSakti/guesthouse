  <footer class="em_main_footer">
            <div class="em_body_navigation -active-links">
                <div class="item_link">
                    <a href="<?php echo site_url('home') ?>" class="btn btn_navLink">
                ...
                <div class="item_link">
                    <a href="<?php echo site_url('home/booking') ?>" class="btn btn_navLink">
                        <div class="icon_current">
               ...
               <div class="item_link">
                            <a href="#" class="btn btn_navLink">
                                <button type="button" class="btn btnCircle" data-toggle="modal" data-target="#mdllSend">
                                    <i class="tio-add"></i>
                                </button>
                            </a>
                        </div>
                <div class="item_link">
                    <a href="<?php echo site_url('home/nopage') ?>" class="btn btn_navLink">
                        <div class="icon_current">
                ...
                <div class="item_link">
                    <a href="<?php echo site_url('home/nopage') ?>" class="btn btn_navLink btn_profile">
                        <div class="img_profile">
                            <img src="<?php echo base_url('assets/frontend/') ?>img/person.png" alt="">
                        </div>
                    </a>
                </div>
            </div>
                        ...
                        <div class="padding-t-20">
                            <form action="<?php echo site_url('home/search_room_avail')  ?>" onsubmit="return ValidationEvent()" method="get">
                                ...
                                <div class="form-group input-lined">
                                   <input type="date" class="form-control" id="date_checkin" name="date_checkin" required="">
                                    <label>Tanggal Check In</label>
                                </div>
                                 <div class="form-group input-lined">
                                   <input type="time" class="form-control"  name="time_checkin"  required="">
                                    <label>Jam Check In</label>
                                </div>
                                <div class="form-group input-lined">
                                    <input type="date" class="form-control" id="date_checkout"  name="date_checkout"  required="">
                                    <label>Tanggal Check Out</label>
                                </div>
                                 <div class="form-group input-lined">
                                   <input type="time" class="form-control" name="time_checkout"  required="">
                                    <label>Jam Check Out</label>
                                </div>
                                <div class="form-group input-lined relative">
                                    <input type="number" class="form-control" name="person"   min="0" placeholder="Jumlah tamu"
                                        required="">
