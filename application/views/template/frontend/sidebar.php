                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <div class="em_profile_user">
                            <div class="media">
                                <a href="#">
                                    <img class="_imgUser" src="<?php echo base_url('assets/frontend/') ?>img/person.png" alt="">
                                </a>
                                <div class="media-body">
                                    <div class="txt">
                                        <h3><?php echo $namalogin; ?></h3>
                                        <p><?php echo $email; ?></p>
                                        <a href="<?php echo site_url('auth_user/logout') ?>" class="btn btn_logOut">Sign out</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-body">
                        <ul class="nav flex-column -active-links">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="<?php echo site_url('home/booking') ?>">
                                    <div class="">
                                        <div class="icon_current">
                                        ...
                                        <span class="title_link">List Booking</span>
                                    </div>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#"  class="close" data-dismiss="modal" aria-label="Close"  data-toggle="modal" data-target="#mdllSend">
                                    <div class="">
                                        <div class="icon_current">
                                        ...
                                        <span class="title_link">Booking Now</span>
                                    </div>
                                   <div class="em_pulp">
                    ...
                    <div class="modal-footer">
                        <div class="em_darkMode_menu">
                            ...
                            <label class="switch_toggle" for="switchDarkMode">
