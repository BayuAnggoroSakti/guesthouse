<!-- Vendor -->
		...
		<script src="<?php echo base_url('assets/'); ?>vendor/bootstrapv5-multiselect/js/bootstrap-multiselect.js"></script>
		...
		<script src="<?php echo base_url('assets/'); ?>vendor/datatables/media/js/dataTables.bootstrap5.min.js"></script>
