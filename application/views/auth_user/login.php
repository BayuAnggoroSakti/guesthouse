            ...
            <section class="em__signTypeOne">
                ...
                <div class="em__body">
                      <?php if (isset($message)) {
                              ...
                              ?>
                        <?php echo form_open("auth_user/login");?>
                ...
                <div class="em__footer">
                    ...
                    <button type="submit" class="btn bg-primary color-white justify-content-center">LOGIN</button>
                    <a href="<?php echo site_url('auth_user/create_user') ?>" class="btn hover:color-secondary justify-content-center">Not a
                        member?
                        Signup now</a>
                </div>
                  <?php echo form_close();?>
