...
class Auth extends CI_Controller
{
	...
	{
		$this->data['title'] = "Login Admin Guest House";
		...
		if ($this->form_validation->run() === TRUE)
		{
			...
			{
				if ($this->ion_auth->is_admin()) // remove this elseif if you want to enable this for 
					{
						$this->session->set_flashdata('message', $this->ion_auth->messages());
						redirect('admin/dashboard', 'refresh');
					}
				else{
					$this->session->set_flashdata('message', '<div class="alert alert-danger" role="alert">Anda tidak punya akses ke menu admin</div>');
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() === FALSE)
		{
			...
			$this->template->display('auth/lupa_password', $this->data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() === FALSE)
			{
				...
				// render
				$this->template->display("auth/reset_password",$this->data);
	...
	public function register($type = '')
	{
		...
		else
		{
			...
			$this->template->display('auth/register', $this->data);
		}
	}
	/**
