...
*/
$config['tables']['users']           = 'GH.USERS';
$config['tables']['groups']          = 'GH.GROUPS';
$config['tables']['users_groups']    = 'GH.USERS_GROUP';
$config['tables']['login_attempts']  = 'GH.LOGIN_ATTEMPTS';
...
$config['admin_email']                = "vgrkpcs@gmail.com"; // Admin Email, admin@example.com
